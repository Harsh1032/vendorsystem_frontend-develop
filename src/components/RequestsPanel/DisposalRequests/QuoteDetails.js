  ...
  return (
    <React.Fragment>
      {!dataReady ? (
        ...
        <React.Fragment>
          {quote && (quote.modified_by || quote.status === "approved") ? (
            <div
            ...
            >
              ...
              <div className="p-d-flex p-jc-between">
                <span className="title font-weight-bold">{t("removalDetails.disposal_quote")}</span>
              </div>
              <div className="p-mt-2 p-d-flex p-flex-column">
                <div className="p-d-flex p-jc-between">
                  <span className="sub-title">{`${t("general.status")}:`}</span>
                  <span className="sub-value">{capitalize(quote.status)}</span>
                </div>
                <div className="p-d-flex p-jc-between">
