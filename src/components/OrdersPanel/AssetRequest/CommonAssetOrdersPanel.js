...
const CommonAssetOrdersPanel = ({
  ...
  if (isAllSelected) {
    ...
    TableData = assetOrders.map((assetOrder) => {
      return {
        id: assetOrder.asset_request_id,
        dataPoint: assetOrder,
        cells: [
          assetOrder.client_request_custom_id
            ? assetOrder.client_request_custom_id
            : t("general.not_applicable"),
          assetOrder.client_name ? assetOrder.client_name : t("general.not_applicable"),
          capitalize(assetOrder.status),
          assetOrder.created_by ? assetOrder.created_by : t("general.not_applicable"),
