  ...
  if (isAllSelected) {
    ...
    TableData = maintenances.map((maintenance) => {
      return {
        ...
        cells: [
          maintenance.client_request_work_order
            ? maintenance.client_request_work_order
            : t("general.not_applicable"),
          maintenance.client_name ? maintenance.client_name : t("general.not_applicable"),
          capitalize(maintenance.status),
          maintenance.created_by ? maintenance.created_by : t("general.not_applicable"),
